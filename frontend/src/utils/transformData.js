...
export function buildWeeklyDistance(sessions) {
  ...
  sessionArray.forEach((s) => {
    ...
    const dayNum = (d.getDay() + 6) % 7; // Trouver le lundi de la semaine
  ...
  // Ajoute la semaine actuelle si vide
...
// Fréquence cardiaque → extrait min / max / moyenne
